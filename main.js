...
{
	if (region.bj.aB === region.bG.aB)
	{
		return 'on line ' + region.bj.aB;
	}
	return 'on lines ' + region.bj.aB + ' through ' + region.bG.aB;
}
...
var _Http_toTask = F3(function(router, toTask, request)
{
	return _Scheduler_binding(function(callback)
	{
		...
		$elm$core$Maybe$isJust(request.dp) && _Http_track(router, xhr, request.dp.a);

		try {
			xhr.open(request.cX, request.aN, true);
		} catch (e) {
...
var $elm$url$Url$Url = F6(
	function (protocol, host, port_, path, query, fragment) {
		return {bM: fragment, bQ: host, b1: path, b3: port_, b6: protocol, b7: query};
	});
...
var $author$project$Main$init = function (_v0) {
	return _Utils_Tuple2(
		{aH: $author$project$Main$Initial, aN: ''},
...
var $elm$http$Http$request = function (r) {
	return $elm$http$Http$command(
		$elm$http$Http$Request(
			{cA: false, bw: r.bw, cM: r.cM, cR: r.cR, cX: r.cX, dn: r.dn, dp: r.dp, aN: r.aN}));
};
...
var $author$project$Main$Alternatives = F4(
	function (first, second, third, fourth) {
		return {bJ: first, bL: fourth, cg: second, cp: third};
	});
...
var $author$project$Main$Definition = F4(
	function (word, fl, def, isOffensive) {
		return {bD: def, bK: fl, bU: isOffensive, cu: word};
	});
					...
					$elm$http$Http$request(
						{
							...
							cM: A2($elm$http$Http$expectJson, $author$project$Main$GotDef, $author$project$Main$respDecoder),
							cR: _List_Nil,
							cX: 'GET',
							dn: $elm$core$Maybe$Just(2000.0),
							dp: $elm$core$Maybe$Nothing,
							aN: model.aN
						}));
			case 1:
				var s = msg.a;
				var root = 'http://localhost:8080/search/';
				var request = function (word) {
					return _Utils_ap(root, word);
				};
				return _Utils_Tuple2(
					_Utils_update(
						model,
				...
				if (!result.$) {
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								aH: $author$project$Main$Success(def)
							}),
						$elm$core$Platform$Cmd$none);
				} else {
					var error = result.a;
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								aH: $author$project$Main$Failure(error)
							}),
						$elm$core$Platform$Cmd$none);
				}
		}
...
var $rtfeldman$elm_css$Css$auto = {cz: 0, a: 0, af: 0, aT: 0, cW: 0, aj: 0, L: 0, D: 0, am: 0, A: 0, a2: 0, ar: 0, w: 0, F: 'auto'};
...
var $rtfeldman$elm_css$Css$boxShadow3 = $rtfeldman$elm_css$Css$prop3('box-shadow');
...
var $rtfeldman$elm_css$Css$row = {a7: 0, ay: 0, F: 'row'};
		...
		switch (declaration.$) {
			...
			case 6:
				...
				return $elm$core$String$isEmpty(record.cG) ? _Utils_Tuple2(keyframesByName, declarations) : _Utils_Tuple2(
					A3($elm$core$Dict$insert, record.c_, record.cG, keyframesByName),
					declarations);
			case 7:
				var properties = declaration.a;
				return $elm$core$List$isEmpty(properties) ? _Utils_Tuple2(keyframesByName, declarations) : _Utils_Tuple2(
...
var $rtfeldman$elm_css$Css$Structure$compactStylesheet = function (_v0) {
	...
	return {bB: charset, cH: finalDeclarations, bR: imports, b_: namespaces};
};
...
var $Skinney$murmur3$Murmur3$HashData = F4(
	function (shift, seed, hash, charsProcessed) {
		return {ac: charsProcessed, ai: hash, X: seed, an: shift};
	});
...
var $Skinney$murmur3$Murmur3$finalize = function (data) {
	var acc = (!(!data.ai)) ? (data.X ^ A2(
		$Skinney$murmur3$Murmur3$multiplyBy,
		$Skinney$murmur3$Murmur3$c2,
		A2(
			$Skinney$murmur3$Murmur3$rotlBy,
			15,
			A2($Skinney$murmur3$Murmur3$multiplyBy, $Skinney$murmur3$Murmur3$c1, data.ai)))) : data.X;
	var h0 = acc ^ data.ac;
...
var $Skinney$murmur3$Murmur3$hashFold = F2(
	function (c, data) {
		var res = data.ai | ((255 & $elm$core$Char$toCode(c)) << data.an);
		var _v0 = data.an;
		if (_v0 === 24) {
			return {
				ac: data.ac + 1,
			...
			return {ac: data.ac + 1, ai: res, X: data.X, an: data.an + 8};
		}
	});
...
var $rtfeldman$elm_css$Css$Preprocess$Resolve$toStructure = function (_v0) {
	...
	var declarations = $rtfeldman$elm_css$Css$Preprocess$Resolve$extract(
		A2($elm$core$List$concatMap, $rtfeldman$elm_css$Css$Preprocess$unwrapSnippet, snippets));
	return {bB: charset, cH: declarations, bR: imports, b_: namespaces};
};
...
var $rtfeldman$elm_css$Css$Preprocess$stylesheet = function (snippets) {
	return {bB: $elm$core$Maybe$Nothing, bR: _List_Nil, b_: _List_Nil, cj: snippets};
};
...
var $rtfeldman$elm_css$Css$stringsToValue = function (list) {
	return $elm$core$List$isEmpty(list) ? {F: 'none'} : {
		F: A2(
			$elm$core$String$join,
			', ',
			A2(
...
var $author$project$Main$paragraphFont = $rtfeldman$elm_css$Css$batch(
	_List_fromArray(
		[
...
var $rtfeldman$elm_css$Css$erroneousHex = function (str) {
	return {
		...
		az: 0,
		aG: 0,
		F: $rtfeldman$elm_css$Css$withPrecedingHash(str)
	};
};
...
var $author$project$Main$theme = {
	bg: $rtfeldman$elm_css$Css$hex('0a0a09'),
	bh: $rtfeldman$elm_css$Css$hex('f7f7f2')
};
...
var $rtfeldman$elm_css$Css$underline = {ap: 0, F: 'underline'};
...
var $rtfeldman$elm_css$Css$zero = {aA: 0, aj: 0, L: 0, ak: 0, al: 0, T: 0, U: 0, aC: 0, N: 0, aY: 0, as: '', aM: 0, F: '0'};
var $author$project$Main$altWords = $rtfeldman$elm_css$Css$batch(
	_List_fromArray(
		[
			A2(
...
var $rtfeldman$elm_css$Css$capitalize = {Z: 0, F: 'capitalize'};
var $author$project$Main$checkOffense = function (b) {
	return b ? $rtfeldman$elm_css$Html$Styled$text('Offensive: true') : $rtfeldman$elm_css$Html$Styled$text('Offensive: false');
};
var $author$project$Main$errorMsg = $rtfeldman$elm_css$Css$batch(
	_List_fromArray(
		[
			$author$project$Main$paragraphFont,
			$rtfeldman$elm_css$Css$marginTop(
			$rtfeldman$elm_css$Css$vh(10))
		]));
var $rtfeldman$elm_css$Css$block = {g: 0, F: 'block'};
var $rtfeldman$elm_css$Css$borderBox = {a4: 0, aQ: 0, F: 'border-box'};
...
var $rtfeldman$elm_css$Css$solid = {r: 0, Y: 0, F: 'solid'};
var $rtfeldman$elm_css$Css$width = $rtfeldman$elm_css$Css$prop1('width');
var $author$project$Main$responseDiv = $rtfeldman$elm_css$Css$batch(
	_List_fromArray(
		[
			$author$project$Main$paragraphFont,
				...
				return A2(
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[$author$project$Main$responseDiv]))
						]),
					_List_fromArray(
						[
							A2(
							...
							_List_fromArray(
								[
									A2($rtfeldman$elm_css$Html$Styled$Attributes$attribute, 'data-cy', 'word'),
									$rtfeldman$elm_css$Html$Styled$Attributes$css(
									_List_fromArray(
										[
							...
							_List_fromArray(
								[
									$rtfeldman$elm_css$Html$Styled$text(d.cu)
								])),
							A2(
							$rtfeldman$elm_css$Html$Styled$div,
							_List_fromArray(
							...
							_List_fromArray(
								[
									$rtfeldman$elm_css$Html$Styled$text(d.bK)
								])),
							A2(
							$rtfeldman$elm_css$Html$Styled$div,
							_List_fromArray(
								[
									A2($rtfeldman$elm_css$Html$Styled$Attributes$attribute, 'data-cy', 'def')
								]),
							_List_fromArray(
								[
									$rtfeldman$elm_css$Html$Styled$text(d.bD)
								])),
							A2(
							$rtfeldman$elm_css$Html$Styled$div,
							_List_fromArray(
							...
							_List_fromArray(
								[
									$author$project$Main$checkOffense(d.bU)
								]))
						]));
			} else {
				var a = resp.a;
						...
						[
							...
							_List_fromArray(
								[
									$rtfeldman$elm_css$Html$Styled$Attributes$css(
									_List_fromArray(
										[$author$project$Main$altWords]))
								]),
							_List_fromArray(
								[
									$rtfeldman$elm_css$Html$Styled$text('Did you mean: ')
								])),
							A2(
							$rtfeldman$elm_css$Html$Styled$div,
							_List_fromArray(
							...
							_List_fromArray(
								[
									$rtfeldman$elm_css$Html$Styled$text(a.bJ)
								])),
							A2(
							$rtfeldman$elm_css$Html$Styled$div,
							_List_fromArray(
							...
							_List_fromArray(
								[
									$rtfeldman$elm_css$Html$Styled$text(a.cg)
								])),
							A2(
							$rtfeldman$elm_css$Html$Styled$div,
							_List_fromArray(
							...
							_List_fromArray(
								[
									$rtfeldman$elm_css$Html$Styled$text(a.cp)
								])),
							A2(
							$rtfeldman$elm_css$Html$Styled$div,
							_List_fromArray(
							...
							_List_fromArray(
								[
									$rtfeldman$elm_css$Html$Styled$text(a.bL)
								]))
						]));
			}
		default:
			...
			switch (error.$) {
				case 4:
					return A2(
						...
						_List_fromArray(
							[
								$rtfeldman$elm_css$Html$Styled$text('Invalid entries')
							]));
				case 2:
					return A2(
						$rtfeldman$elm_css$Html$Styled$div,
						...
						_List_fromArray(
							[
								$rtfeldman$elm_css$Html$Styled$text('Network Error')
							]));
				case 3:
					return A2(
						$rtfeldman$elm_css$Html$Styled$div,
						...
						_List_fromArray(
							[
								$rtfeldman$elm_css$Html$Styled$text('Something\'s wrong with Merriam-Webster API, try later?')
							]));
				case 0:
					return A2(
						$rtfeldman$elm_css$Html$Styled$div,
						...
						_List_fromArray(
							[
								$rtfeldman$elm_css$Html$Styled$text('URL invalid')
							]));
				default:
					return A2(
						$rtfeldman$elm_css$Html$Styled$div,
						...
						_List_fromArray(
							[
								$rtfeldman$elm_css$Html$Styled$text('Time out, try again?')
							]));
			}
	}
};
						...
						[
							...
							_List_fromArray(
								[
									...
									$rtfeldman$elm_css$Css$px(50),
									$rtfeldman$elm_css$Css$zero),
									$rtfeldman$elm_css$Css$backgroundColor($author$project$Main$theme.bh),
									A2(
										...
										[
											...
											_List_fromArray(
												[
													...
													$rtfeldman$elm_css$Css$px(980))
												]))
										]),
									_List_fromArray(
										[
											$rtfeldman$elm_css$Css$width(
											$rtfeldman$elm_css$Css$vw(90)),
											$rtfeldman$elm_css$Css$fontSize(
						...
						[
							...
							_List_fromArray(
								[
									...
									_List_fromArray(
										[
											$author$project$Main$paragraphFont,
											$rtfeldman$elm_css$Css$color($author$project$Main$theme.bg),
											$rtfeldman$elm_css$Css$textAlign($rtfeldman$elm_css$Css$center)
										]))
								]),
							_List_fromArray(
								[
									$rtfeldman$elm_css$Html$Styled$text('Elm Dictionary')
								])),
							A2(
							$rtfeldman$elm_css$Html$Styled$div,
							_List_fromArray(
							...
							_List_fromArray(
								[
									...
									_List_fromArray(
										[
											$rtfeldman$elm_css$Html$Styled$Attributes$for('userInput')
										]),
									_List_Nil),
									A2(
									...
									_List_fromArray(
										[
											...
											$rtfeldman$elm_css$Html$Styled$Events$onInput($author$project$Main$NewContent),
											A2($rtfeldman$elm_css$Html$Styled$Attributes$attribute, 'data-cy', 'input'),
											A2($rtfeldman$elm_css$Html$Styled$Attributes$attribute, 'id', 'userInput'),
											$rtfeldman$elm_css$Html$Styled$Attributes$css(
											_List_fromArray(
												[
									...
									_List_fromArray(
										[
											$rtfeldman$elm_css$Html$Styled$Events$onClick($author$project$Main$Search),
											A2($rtfeldman$elm_css$Html$Styled$Attributes$attribute, 'data-cy', 'submit'),
											$rtfeldman$elm_css$Html$Styled$Attributes$css(
											_List_fromArray(
												[
													$rtfeldman$elm_css$Css$backgroundColor($author$project$Main$theme.bg),
													$rtfeldman$elm_css$Css$color($author$project$Main$theme.bh),
													$rtfeldman$elm_css$Css$padding(
...
var $author$project$Main$main = $elm$browser$Browser$document(
	{cV: $author$project$Main$init, dk: $author$project$Main$subscriptions, dq: $author$project$Main$update, ds: $author$project$Main$view});
