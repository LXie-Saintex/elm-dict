...
*/
  ...
  var _Http_toTask = F3(function (router, toTask, request) {
    return _Scheduler_binding(function (callback) {
      ...
      $elm$core$Maybe$isJust(request.tracker) &&
          ...
          _Utils_Tuple2(
            ...
            $elm$http$Http$Receiving({
              ...
              size: event.lengthComputable
                ? $elm$core$Maybe$Just(event.total)
                : $elm$core$Maybe$Nothing,
            })
          )
        )
  ...
  var $author$project$Main$Definition = F4(function (word, fl, def, offensive) {
  ...
  var $author$project$Main$defDecoder = A5(
    ...
    A2(
      ...
      A2(
        $elm$json$Json$Decode$at,
        _List_fromArray(["meta", "app-shortdef", "fl"]),
        $elm$json$Json$Decode$string
      )
    ),
    A2(
      ...
      A2(
        $elm$json$Json$Decode$at,
        _List_fromArray(["meta", "app-shortdef", "def"]),
    ...
    A2(
      ...
      A2(
        $elm$json$Json$Decode$at,
        _List_fromArray(["meta", "offensive"]),
  ...
  var $elm$http$Http$expectJson = F2(function (toMsg, decoder) {
    return A2(
      ...
      toMsg,
      $elm$http$Http$resolve(function (string) {
        return A2(
          $elm$core$Result$mapError,
  ...
  var $elm$http$Http$maybeSend = F4(function (
    router,
    desiredTracker,
    progress,
    _v0
    ...
    var toMsg = _v0.b;
    return _Utils_eq(desiredTracker, actualTracker)
      ? $elm$core$Maybe$Just(
          A2($elm$core$Platform$sendToApp, router, toMsg(progress))
        )
      : $elm$core$Maybe$Nothing;
  });
  ...
  _Platform_effectManagers["Http"] = _Platform_createManager(
    $elm$http$Http$init,
        ...
        return _Utils_Tuple2(
          ...
          $elm$http$Http$get({
            expect: A2(
              ...
              $author$project$Main$GotDef,
              $author$project$Main$defDecoder
            ),
            url: model.url,
          })
        );
  ...
  var $author$project$Main$viewInput = F2(function (t, toMsg) {
    return A2(
      $elm$html$Html$input,
      _List_fromArray([
  ...
  var $author$project$Main$checkOffense = function (b) {
    return b
      ? $elm$html$Html$text("Offensive: true")
      : $elm$html$Html$text("Offensive: false");
  };
        ...
        return A2(
          ...
          _List_fromArray([
            A2(
              $elm$html$Html$div,
              _List_Nil,
              _List_fromArray([$elm$html$Html$text(d.word)])
            ),
            A2(
              $elm$html$Html$div,
              _List_Nil,
              _List_fromArray([$elm$html$Html$text(d.fl)])
            ),
            A2(
              $elm$html$Html$div,
              _List_Nil,
              _List_fromArray([$elm$html$Html$text(d.def)])
            ),
            A2(
              $elm$html$Html$div,
              _List_Nil,
              _List_fromArray([$author$project$Main$checkOffense(d.offensive)])
            ),
          ])
        );
      default:
        var error = _v0.a;
        return $elm$html$Html$text($elm$core$Debug$toString(error));
    }
  };
        ...
        A2(
          ...
          _List_fromArray([
            A2(
              $elm$html$Html$div,
              _List_Nil,
              _List_fromArray([$elm$html$Html$text("Elm Dictionary")])
            ),
            A2(
            ...
            A2(
              ...
              _List_fromArray([$elm$html$Html$text("Search")])
            ),
