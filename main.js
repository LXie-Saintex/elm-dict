...
var $author$project$Main$update = F2(
	function (msg, model) {
		switch (msg.$) {
			...
			case 'NewContent':
				var s = msg.a;
				var root = 'https://www.dictionaryapi.com/api/v3/references/learners/json/';
				var key = '24375962-78c5-4fbc-a585-b37ed4088caf';
				var request = function (word) {
					return root + (word + ('?key=' + key));
				};
				return _Utils_Tuple2(
					_Utils_update(
						model,
				...
				if (result.$ === 'Ok') {
					...
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								status: $author$project$Main$Success(def)
							}),
						$elm$core$Platform$Cmd$none);
				} else {
					var error = result.a;
					return _Utils_Tuple2(
						_Utils_update(
							model,
							{
								status: $author$project$Main$Failure(error)
							}),
						$elm$core$Platform$Cmd$none);
				}
		}
...
var $author$project$Main$theme = {
	primary: $rtfeldman$elm_css$Css$hex('0a0a09'),
	secondary: $rtfeldman$elm_css$Css$hex('f7f7f2')
};
				...
				return A2(
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									$rtfeldman$elm_css$Html$Styled$text(d.word)
								])),
							A2(
							$rtfeldman$elm_css$Html$Styled$div,
							_List_fromArray(
							...
							_List_fromArray(
								[
									$rtfeldman$elm_css$Html$Styled$text(d.fl)
								])),
							A2(
							$rtfeldman$elm_css$Html$Styled$div,
							_List_fromArray(
							...
							_List_fromArray(
								[
									$rtfeldman$elm_css$Html$Styled$text(d.def)
								])),
							A2(
							$rtfeldman$elm_css$Html$Styled$div,
							_List_fromArray(
				...
				return A2(
					...
					_List_fromArray(
						[
							...
							_List_fromArray(
								[
									$rtfeldman$elm_css$Html$Styled$text(a.first)
								])),
							A2(
							$rtfeldman$elm_css$Html$Styled$div,
							_List_fromArray(
							...
							_List_fromArray(
								[
									$rtfeldman$elm_css$Html$Styled$text(a.second)
								])),
							A2(
							$rtfeldman$elm_css$Html$Styled$div,
							_List_fromArray(
							...
							_List_fromArray(
								[
									$rtfeldman$elm_css$Html$Styled$text(a.third)
								])),
							A2(
							$rtfeldman$elm_css$Html$Styled$div,
							_List_fromArray(
							...
							_List_fromArray(
								[
									$rtfeldman$elm_css$Html$Styled$text(a.fourth)
								]))
						]));
			}
		default:
			...
			switch (error.$) {
				...
				case 'NetworkError':
					return A2(
						...
						_List_fromArray(
							[
								$rtfeldman$elm_css$Html$Styled$text('No internet connection')
							]));
				case 'BadStatus':
					return A2(
						$rtfeldman$elm_css$Html$Styled$div,
										...
										[
											...
											_List_fromArray(
												[
													...
													$rtfeldman$elm_css$Css$color($author$project$Main$theme.secondary),
													$rtfeldman$elm_css$Css$padding(
